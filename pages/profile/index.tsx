      ...
      <div className="px-4">
        <div className="flex items-center space-x-3">
          ...
          <div className="flex flex-col">
            ...
            <Link href={'/profile/edit'}><span className="text-sm text-gray-700 cursor-pointer">Edit profile &rarr;</span></Link>
          </div>
        </div>
        <div className="mt-10 flex justify-around">
          <Link href={'/profile/sold'}><div className="flex flex-col items-center cursor-pointer">
          ...
          <Link href={'/profile/bought'}><div className="flex flex-col items-center cursor-pointer">
            <div className="w-14 h-14 text-white bg-orange-500 rounded-full flex items-center justify-center">
              <svg
                className="w-6 h-6"
                fill="none"
          ...
          <Link href={'/profile/love'}><div className="flex flex-col items-center cursor-pointer">
            <div className="w-14 h-14 text-white bg-orange-500 rounded-full flex items-center justify-center">
              <svg
                className="w-6 h-6"
                fill="none"
