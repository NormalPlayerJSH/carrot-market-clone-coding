...
const Community: NextPage = () => {
  return (
    <Layout title="동네생활" hasTabBar canGoBack >
      <div className=" px-4 space-y-8">
        ...
        <Link href={'/community/write'}><button className="fixed bottom-20 right-5 bg-orange-400 rounded-full p-4 text-white shadow-xl hover:bg-orange-500 cursor-pointer transition-colors">
          <svg
            className="w-6 h-6"
            fill="none"
            stroke="currentColor"
